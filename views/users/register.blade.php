            ...
            <div class="mt-4 login">
                <form method="post" action="{{route('users.do_register')}}">
                    ...
                    <p class="text-primary">
                        If your already have account please click here <a href="{{route('users.login')}}" class="text-reset">Sign in Now</a>.
                    </p>
                    <input class="btn btn-warning btn-sign-in" type="submit" value="Create">
                    <a href="{{route('users.login')}}"><input type="button" class="btn btn-danger btn-back" value="Back"></a>
                </form>
            </div>
        </div>     
    </div>
