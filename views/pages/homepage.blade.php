...
<head>
    ...
    <link rel="stylesheet" href="{{asset('fontawesome-v6/css/all.css')}}">
...
<body>
    <div class="container mt-4">
        ...
        @if (Auth::guest())
            <a href="{{route('users.login')}}" id="sign-in"><button class="btn btn-primary">Sign In</button></a>
        @else 
            <p class="caret" id="username">{{ Auth::user()->name }}<i  class="fa-solid fa-user"></i></p>
